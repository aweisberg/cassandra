...
public class GossipingPropertyFileSnitch extends AbstractNetworkTopologySnitch// implements IEndpointStateChangeSubscriber
{
    ...
    private Map<InetAddressAndPorts, Map<String, String>> savedEndpoints;
    ...
    public void gossiperStarting()
    {
        ...
        Gossiper.instance.addLocalApplicationState(ApplicationState.INTERNAL_ADDRESS_AND_PORTS,
                                                   StorageService.instance.valueFactory.internalAddressAndPorts(FBUtilities.getLocalAddressAndPorts()));
