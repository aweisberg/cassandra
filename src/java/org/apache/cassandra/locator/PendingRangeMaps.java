...
public class PendingRangeMaps implements Iterable<Map.Entry<Range<Token>, List<InetAddressAndPorts>>>
{
    ...
    final NavigableMap<Range<Token>, List<InetAddressAndPorts>> ascendingMap;
    /**
    ...
    final NavigableMap<Range<Token>, List<InetAddressAndPorts>> descendingMap;
    /**
    ...
    final NavigableMap<Range<Token>, List<InetAddressAndPorts>> ascendingMapForWrapAround;
    /**
    ...
    final NavigableMap<Range<Token>, List<InetAddressAndPorts>> descendingMapForWrapAround;
    /**
    ...
    {
        this.ascendingMap = new TreeMap<Range<Token>, List<InetAddressAndPorts>>(ascendingComparator);
        this.descendingMap = new TreeMap<Range<Token>, List<InetAddressAndPorts>>(descendingComparator);
        this.ascendingMapForWrapAround = new TreeMap<Range<Token>, List<InetAddressAndPorts>>(ascendingComparatorForWrapAround);
        this.descendingMapForWrapAround = new TreeMap<Range<Token>, List<InetAddressAndPorts>>(descendingComparatorForWrapAround);
    }

    static final void addToMap(Range<Token> range,
                               InetAddressAndPorts address,
                               NavigableMap<Range<Token>, List<InetAddressAndPorts>> ascendingMap,
                               NavigableMap<Range<Token>, List<InetAddressAndPorts>> descendingMap)
    {
        List<InetAddressAndPorts> addresses = ascendingMap.get(range);
        if (addresses == null)
        {
    ...
    public void addPendingRange(Range<Token> range, InetAddressAndPorts address)
    {
    ...
    static final void addIntersections(Set<InetAddressAndPorts> endpointsToAdd,
                                       NavigableMap<Range<Token>, List<InetAddressAndPorts>> smallerMap,
                                       NavigableMap<Range<Token>, List<InetAddressAndPorts>> biggerMap)
    {
        // find the intersection of two sets
        for (Range<Token> range : smallerMap.keySet())
        {
            List<InetAddressAndPorts> addresses = biggerMap.get(range);
            if (addresses != null)
            {
    ...
    public Collection<InetAddressAndPorts> pendingEndpointsFor(Token token)
    {
        Set<InetAddressAndPorts> endpoints = new HashSet<>();

        Range searchRange = new Range(token, token);

        // search for non-wrap-around maps
        NavigableMap<Range<Token>, List<InetAddressAndPorts>> ascendingTailMap = ascendingMap.tailMap(searchRange, true);
        NavigableMap<Range<Token>, List<InetAddressAndPorts>> descendingTailMap = descendingMap.tailMap(searchRange, false);
        ...
        for (Map.Entry<Range<Token>, List<InetAddressAndPorts>> entry : ascendingTailMap.entrySet())
        {
            endpoints.addAll(entry.getValue());
        }
        for (Map.Entry<Range<Token>, List<InetAddressAndPorts>> entry : descendingTailMap.entrySet())
        {
            endpoints.addAll(entry.getValue());
        }
    ...
    public String printPendingRanges()
    {
        ...
        for (Map.Entry<Range<Token>, List<InetAddressAndPorts>> entry : this)
        {
    ...
    @Override
    public Iterator<Map.Entry<Range<Token>, List<InetAddressAndPorts>>> iterator()
    {
