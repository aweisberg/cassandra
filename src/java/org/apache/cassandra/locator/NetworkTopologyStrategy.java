...
public class NetworkTopologyStrategy extends AbstractReplicationStrategy
{
    ...
    private static final class DatacenterEndpoints
    {
        ...
        DatacenterEndpoints(int rf, int rackCount, int nodeCount, Set<InetAddressAndPorts> endpoints, Set<Pair<String, String>> racks)
        {
         ...
         */
        boolean addEndpointAndCheckIfDone(InetAddressAndPorts ep, Pair<String,String> location)
        {
            if (done())
                return false;
     ...
     */
    public List<InetAddressAndPorts> calculateNaturalEndpoints(Token searchToken, TokenMetadata tokenMetadata)
    {
    ...
    private static Set<String> buildValidDataCentersSet()
    {
        ...
        for (final InetAddressAndPorts peer : StorageService.instance.getTokenMetadata().getAllEndpoints())
        {
