...
public abstract class AbstractNetworkTopologySnitch extends AbstractEndpointSnitch
{
     ...
     */
    abstract public String getRack(InetAddressAndPorts endpoint);
     ...
     */
    abstract public String getDatacenter(InetAddressAndPorts endpoint);

    public int compareEndpoints(InetAddressAndPorts address, InetAddressAndPorts a1, InetAddressAndPorts a2)
    {
