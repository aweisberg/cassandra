 ...
 */
public abstract class MpscLinkedQueueBase<E> implements Queue<E> {
    ...
    protected abstract MpscLinkedQueueNode<E> tailRef();

    protected abstract void setTailRef(MpscLinkedQueueNode<E> tailRef);

    @SuppressWarnings("unchecked")
    protected abstract MpscLinkedQueueNode<E> getAndSetTailRef(MpscLinkedQueueNode<E> tailRef);

    protected abstract MpscLinkedQueueNode<E> headRef();

    protected abstract void setHeadRef(MpscLinkedQueueNode<E> headRef);

    protected abstract void lazySetHeadRef(MpscLinkedQueueNode<E> headRef);
