...
public class PaxosUpdateLowBallot extends AsyncFuture<Void> implements RequestCallbackWithFailure<Void>, Runnable
{
    ...
    {
        checkArgument(maxHLC != BarrierResult.NO_HLC);
        this.ctx = ctx;
