...
public class PaxosPropose<OnDone extends Consumer<? super PaxosPropose.Status>> extends PaxosRequestCallback<PaxosState.AcceptResult>
{
    ...
    static class Status
    {
        enum Outcome { SUCCESS, SUPERSEDED, MAYBE_FAILURE, RETRY_DIFFERENT_SYSTEM }
    ...
    private static final Status STATUS_RETRY_DIFFERENT_SYSTEM = new Status(Outcome.RETRY_DIFFERENT_SYSTEM);
