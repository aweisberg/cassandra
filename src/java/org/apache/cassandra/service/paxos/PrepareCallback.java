...
public class PrepareCallback extends AbstractPaxosCallback<PrepareResponse>
{
    ...
    private final Map<Endpoint, Commit> commitsByReplica = new ConcurrentHashMap<>();
    ...
    public Iterable<Endpoint> replicasMissingMostRecentCommit(TableMetadata metadata, int nowInSec)
    {
        ...
        return Iterables.filter(commitsByReplica.keySet(), new Predicate<Endpoint>()
        {
            public boolean apply(Endpoint inetAddress)
            {
