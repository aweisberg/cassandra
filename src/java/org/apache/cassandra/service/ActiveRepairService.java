...
public class ActiveRepairService implements IEndpointStateChangeSubscriber, IFailureDetectionEventListener, ActiveRepairServiceMBean
{
                                             ...
                                             Collection<String> hosts)
    {
        ...
        {
            Set<Endpoint> specifiedHost = new HashSet<>();
            for (final String host : hosts)
            {
                try
                {
                    final Endpoint endpoint = Endpoint.getByName(host.trim());
    ...
    public UUID prepareForRepair(UUID parentRepairSession, Endpoint coordinator, Set<Endpoint> endpoints, RepairOption options, boolean isForcedRepair, List<ColumnFamilyStore> columnFamilyStores)
    {
        ...
        for (Endpoint neighbour : endpoints)
        {
    ...
    public synchronized void registerParentRepairSession(UUID parentRepairSession, Endpoint coordinator, List<ColumnFamilyStore> columnFamilyStores, Collection<Range<Token>> ranges, boolean isIncremental, long repairedAt, boolean isGlobal, PreviewKind previewKind)
    {
    ...
    public void handleMessage(Endpoint endpoint, RepairMessage message)
    {
    ...
    public static class ParentRepairSession
    {
        ...
        public ParentRepairSession(Endpoint coordinator, List<ColumnFamilyStore> columnFamilyStores, Collection<Range<Token>> ranges, boolean isIncremental, long repairedAt, boolean isGlobal, PreviewKind previewKind)
        {
