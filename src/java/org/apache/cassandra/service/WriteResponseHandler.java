...
public class WriteResponseHandler<T> extends AbstractWriteResponseHandler<T>
{
    ...
    public WriteResponseHandler(Collection<Endpoint> writeEndpoints,
    ...
    public WriteResponseHandler(Endpoint endpoint, WriteType writeType, Runnable callback, long queryStartNanoTime)
    {
        this(Arrays.asList(endpoint), Collections.<Endpoint>emptyList(), ConsistencyLevel.ONE, null, callback, writeType, queryStartNanoTime);
    }

    public WriteResponseHandler(Endpoint endpoint, WriteType writeType, long queryStartNanoTime)
    {
