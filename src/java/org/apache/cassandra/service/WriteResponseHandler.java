...
public class WriteResponseHandler<T> extends AbstractWriteResponseHandler<T>
{
    ...
    public WriteResponseHandler(Collection<InetAddressAndPorts> writeEndpoints,
    ...
    public WriteResponseHandler(InetAddressAndPorts endpoint, WriteType writeType, Runnable callback, long queryStartNanoTime)
    {
        this(Arrays.asList(endpoint), Collections.<InetAddressAndPorts>emptyList(), ConsistencyLevel.ONE, null, callback, writeType, queryStartNanoTime);
    }

    public WriteResponseHandler(InetAddressAndPorts endpoint, WriteType writeType, long queryStartNanoTime)
    {
