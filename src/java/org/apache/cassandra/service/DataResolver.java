...
public class DataResolver extends ResponseResolver
{
    ...
    public PartitionIterator resolve()
    {
        ...
        InetAddressAndPorts[] sources = new InetAddressAndPorts[count];
    ...
    private PartitionIterator mergeWithShortReadProtection(List<UnfilteredPartitionIterator> results, InetAddressAndPorts[] sources, DataLimits.Counter resultCounter)
    {
    ...
    {
        private final InetAddressAndPorts[] sources;

        public RepairMergeListener(InetAddressAndPorts[] sources)
        {
    ...
    {
        private final InetAddressAndPorts source;
        private final DataLimits.Counter counter;
        private final DataLimits.Counter postReconciliationCounter;
        private final long queryStartNanoTime;

        private ShortReadProtection(InetAddressAndPorts source, DataLimits.Counter postReconciliationCounter, long queryStartNanoTime)
        {
            this.source = source;
