...
public interface ReadRepair
{
     ...
     */
    UnfilteredPartitionIterators.MergeListener getMergeListener(Endpoint[] endpoints);
    ...
    public void startRepair(DigestResolver digestResolver,
                            ...
                            List<Endpoint> contactedEndpoints,
    ...
    static ReadRepair create(ReadCommand command, List<Endpoint> endpoints, long queryStartNanoTime, ConsistencyLevel consistency)
    {
