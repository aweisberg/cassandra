...
public class TokenRange
{
    ...
    public static TokenRange create(Token.TokenFactory tokenFactory, Range<Token> range, List<InetAddressAndPorts> endpoints, boolean withPorts)
    {
    ...
    {
        public final InetAddressAndPorts host;
        public final String nativeAddress;
        public final String datacenter;
        public final String rack;

        private EndpointDetails(InetAddressAndPorts host, String nativeAddress, String datacenter, String rack)
        {
