...
public enum TransactionalMode
{
    ...
    public final boolean ignoreSuppliedCommitCL;
    ...
    TransactionalMode(boolean accordIsEnabled, boolean ignoreSuppliedCommitCL, boolean writesThroughAccord, boolean readsThroughAccord, boolean blockingReadRepairThroughAccord)
    {
        this.accordIsEnabled = accordIsEnabled;
        this.ignoreSuppliedCommitCL = ignoreSuppliedCommitCL;
