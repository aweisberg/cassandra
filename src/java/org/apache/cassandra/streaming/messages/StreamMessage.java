...
public abstract class StreamMessage
{
    ...
    public static void serialize(StreamMessage message, DataOutputStreamAndChannelPlus out, int version, StreamSession session) throws IOException
    {
    ...
    public static interface Serializer<V extends StreamMessage>
    {
        ...
        void serialize(V message, DataOutputStreamAndChannelPlus out, int version, StreamSession session) throws IOException;
    }
