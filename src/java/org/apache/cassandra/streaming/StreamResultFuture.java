...
public final class StreamResultFuture extends AbstractFuture<StreamState>
{
    ...
    private void attachConnection(InetAddressAndPorts from, int sessionIndex, IncomingStreamingConnection connection, boolean isForOutgoing, int version) throws IOException
    {
