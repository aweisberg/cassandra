...
final class HintsDispatchExecutor
{
    ...
    private final Predicate<Endpoint> isAlive;
    private final Map<UUID, Future> scheduledDispatches;

    HintsDispatchExecutor(File hintsDirectory, int maxThreads, AtomicBoolean isPaused, Predicate<Endpoint> isAlive)
    {
    ...
    private final class TransferHintsTask implements Runnable
    {
        ...
        public void run()
        {
            ...
            Endpoint address = StorageService.instance.getEndpointForHostId(hostId);
    ...
    private final class DispatchHintsTask implements Runnable
    {
        ...
        private boolean deliver(HintsDescriptor descriptor, Endpoint address)
        {
