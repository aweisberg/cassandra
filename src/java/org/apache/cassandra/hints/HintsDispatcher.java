...
final class HintsDispatcher implements AutoCloseable
{
    ...
    private HintsDispatcher(HintsReader reader, UUID hostId, Endpoint address, int messagingVersion, BooleanSupplier abortRequested)
    {
    ...
    static HintsDispatcher create(File file, RateLimiter rateLimiter, Endpoint address, UUID hostId, BooleanSupplier abortRequested)
    {
