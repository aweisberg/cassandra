...
public final class SystemDistributedKeyspace
{
    ...
    public static void startRepairs(UUID id, UUID parent_id, String keyspaceName, String[] cfnames, Collection<Range<Token>> ranges, Iterable<Endpoint> endpoints)
    {
        Endpoint coordinator = FBUtilities.getBroadcastAddressAndPort();
