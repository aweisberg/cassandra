...
public class CoordinatorSession extends ConsistentSession
{
    ...
    private final Map<Endpoint, State> participantStates = new HashMap<>();
    ...
    {
        super(builder);
        for (Endpoint participant : participants)
        {
    ...
    public synchronized void setParticipantState(Endpoint participant, State state)
    {
    ...
    public ListenableFuture<Boolean> prepare()
    {
        ...
        for (final Endpoint participant : participants)
        {
    ...
    public synchronized void handlePrepareResponse(Endpoint participant, boolean success)
    {
    ...
    public synchronized void handleFinalizePromise(Endpoint participant, boolean success)
    {
        if (getState() == State.FAILED)
        {
