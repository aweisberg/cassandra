...
public class SyncStatSummary
{
    ...
    private static class Session
    {
        ...
        Session(Endpoint src, Endpoint dst)
        {
            this.src = src;
            this.dst = dst;
        }
    ...
    private static class Table
    {
        ...
        final Map<Pair<Endpoint, Endpoint>, Session> sessions = new HashMap<>();
        ...
        Session getOrCreate(Endpoint from, Endpoint to)
        {
            Pair<Endpoint, Endpoint> k = Pair.create(from, to);
