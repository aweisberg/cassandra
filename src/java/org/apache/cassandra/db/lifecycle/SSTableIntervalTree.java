...
public class SSTableIntervalTree extends IntervalTree<PartitionPosition, SSTableReader, Interval<PartitionPosition, SSTableReader>>
{
    ...
    SSTableIntervalTree(IntervalNode head, int count, int modCount, Interval<PartitionPosition, SSTableReader>[] minOrder, Interval<PartitionPosition, SSTableReader>[] maxOrder)
    {
        super(head, count, modCount, minOrder, maxOrder);
    }
    ...
    @Override
    protected SSTableIntervalTree create(IntervalNode head, int count, int modCount, Interval<PartitionPosition, SSTableReader>[] minOrder, Interval<PartitionPosition, SSTableReader>[] maxOrder)
    {
        return new SSTableIntervalTree(head, count, modCount, minOrder, maxOrder);
    }
    ...
    public static SSTableIntervalTree replace(SSTableIntervalTree tree, Map<SSTableReader, SSTableReader> replacementMap)
    {
        ...
        return (SSTableIntervalTree) tree.replace(replacementIntervalsMap);
    }
