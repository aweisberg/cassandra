...
public class PartitionRangeReadCommand extends ReadCommand implements PartitionRangeReadQuery
{
    ...
    {
        super(serializedAtEpoch, Kind.PARTITION_RANGE, isDigest, digestVersion, acceptsTransient, allowOutOfRangeReads, metadata, nowInSec, columnFilter, rowFilter, limits, indexQueryPlan, trackWarnings);
    ...
    {
        return StorageProxy.getRangeSlice(this, consistency, ReadCoordinator.DEFAULT, queryStartNanoTime);
    }
