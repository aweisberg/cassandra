...
public class PartitionRangeReadCommand extends ReadCommand implements PartitionRangeReadQuery
{
    ...
    {
        super(serializedAtEpoch, Kind.PARTITION_RANGE, isDigest, digestVersion, acceptsTransient, allowsPotentialTxnConflicts, metadata, nowInSec, columnFilter, rowFilter, limits, indexQueryPlan, trackWarnings, dataRange);
    ...
    private static class Deserializer extends SelectionDeserializer
    {
        ...
        throws IOException
        {
            ...
            return PartitionRangeReadCommand.create(serializedAtEpoch, isDigest, digestVersion, acceptsTransient, allowsPotentialTxnConflicts, metadata, nowInSec, columnFilter, rowFilter, limits, range, indexQueryPlan, false);
        }
    }
