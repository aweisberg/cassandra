...
public final class ViewUtils
{
     ...
     */
    public static Optional<InetAddressAndPorts> getViewNaturalEndpoint(String keyspaceName, Token baseToken, Token viewToken)
    {
        ...
        List<InetAddressAndPorts> baseEndpoints = new ArrayList<>();
        List<InetAddressAndPorts> viewEndpoints = new ArrayList<>();
        for (InetAddressAndPorts baseEndpoint : replicationStrategy.getNaturalEndpoints(baseToken))
        {
        ...
        for (InetAddressAndPorts viewEndpoint : replicationStrategy.getNaturalEndpoints(viewToken))
        {
