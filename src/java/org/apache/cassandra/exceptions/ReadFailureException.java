...
public class ReadFailureException extends RequestFailureException
{
    ...
    public ReadFailureException(ConsistencyLevel consistency, int received, int blockFor, boolean dataPresent, Map<Endpoint, RequestFailureReason> failureReasonByEndpoint)
    {
