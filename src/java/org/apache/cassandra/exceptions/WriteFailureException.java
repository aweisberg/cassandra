...
public class WriteFailureException extends RequestFailureException
{
    ...
    public WriteFailureException(ConsistencyLevel consistency, int received, int blockFor, WriteType writeType, Map<Endpoint, RequestFailureReason> failureReasonByEndpoint)
    {
