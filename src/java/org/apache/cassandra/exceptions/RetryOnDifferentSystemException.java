...
/**
 * Thrown when a non-transactional operation is attempted when the operation needs to be done transactionally
 * or it could interfere with operations performed transactionally.
 *
