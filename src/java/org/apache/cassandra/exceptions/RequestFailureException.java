...
public class RequestFailureException extends RequestExecutionException
{
    ...
    public final Map<InetAddressAndPorts, RequestFailureReason> failureReasonByEndpoint;

    protected RequestFailureException(ExceptionCode code, ConsistencyLevel consistency, int received, int blockFor, Map<InetAddressAndPorts, RequestFailureReason> failureReasonByEndpoint)
    {
