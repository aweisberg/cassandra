                ...
                case READ_FAILURE:
                    {
                        ...
                        Map<InetAddressAndPorts, RequestFailureReason> failureReasonByEndpoint = new ConcurrentHashMap<>();
                        if (version.isGreaterOrEqualTo(ProtocolVersion.V5))
                        {
                            for (int i = 0; i < failure; i++)
                            {
                                ...
                                failureReasonByEndpoint.put(InetAddressAndPorts.getByAddress(endpoint), failureReason);
                            }
                        }
                ...
                case READ_FAILURE:
                    {
                        ...
                        if (version.isGreaterOrEqualTo(ProtocolVersion.V5))
                        {
                            for (Map.Entry<InetAddressAndPorts, RequestFailureReason> entry : rfe.failureReasonByEndpoint.entrySet())
                            {
