...
public class RowDataReference extends Term.NonTerminal
{
    ...
    public static class Raw extends Term.Raw
    {
        ...
        public void resolveReference(Map<Integer, ReferenceSource> sources, Map<String, Integer> nameToTxnDataName, int userReadIndex)
        {
            ...
            tupleName = nameToTxnDataName.getOrDefault(tuple.toString(), userReadIndex);
            ReferenceSource source = sources.get(tupleName);
            checkNotNull(source, CANNOT_FIND_TUPLE_MESSAGE, tuple.toString());
            ...
            checkNotNull(column, COLUMN_NOT_IN_TUPLE_MESSAGE, selected.toString(), tuple.toString());
