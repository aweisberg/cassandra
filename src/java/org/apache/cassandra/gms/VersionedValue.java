...
public class VersionedValue implements Comparable<VersionedValue>
{
    ...
    public static class VersionedValueFactory
    {
        ...
        public VersionedValue bootReplacingWithPorts(InetAddressAndPorts oldNode)
        {
        ...
        public VersionedValue nativeaddressAndPorts(InetAddressAndPorts address)
        {
        ...
        public VersionedValue internalAddressAndPorts(InetAddressAndPorts address)
        {
            return new VersionedValue(address.toString());
        }
