...
public class GossipDigestSynVerbHandler implements IVerbHandler<GossipDigestSyn>
{
    ...
    {
        InetAddressAndPorts from = message.from;
        ...
        Map<InetAddressAndPorts, EndpointState> deltaEpStateMap = new HashMap<InetAddressAndPorts, EndpointState>();
     ...
     * version in the GossipDigest and the version in the local state for a given InetAddressAndPorts.
    ...
    */
    private void doSort(List<GossipDigest> gDigestList)
    {
        ...
        Map<InetAddressAndPorts, GossipDigest> epToDigestMap = new HashMap<InetAddressAndPorts, GossipDigest>();
        for (GossipDigest gDigest : gDigestList)
        {
        ...
        */
        ...
        for (GossipDigest gDigest : gDigestList)
        {
            InetAddressAndPorts ep = gDigest.getEndpoint();
