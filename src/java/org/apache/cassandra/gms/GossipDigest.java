...
public class GossipDigest implements Comparable<GossipDigest>
{
    ...
    GossipDigest(InetAddressAndPorts ep, int gen, int version)
    {
        endpoint = ep;
        generation = gen;
        maxVersion = version;
    ...
    InetAddressAndPorts getEndpoint()
    {
        return endpoint;
    }
...
class GossipDigestSerializer implements IVersionedSerializer<GossipDigest>
{
    ...
    {
        InetAddressAndPorts endpoint = CompactEndpointSerializationHelper.instance.deserialize(in, version);
