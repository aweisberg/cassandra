...
class OnClusterConsensusMigrations extends Action
{
    ...
    {
        System.out.println("Running OnClusterMigrateConsensus");
        ...
        for (int i = 0; i < migrations; i++)
        {
            ...
            {
                System.out.println("Scheduling migration away from Accord");
                targetMode = TransactionalMode.off;
            }
            else
            {
                System.out.println("Scheduling migration to Accord");
            }
