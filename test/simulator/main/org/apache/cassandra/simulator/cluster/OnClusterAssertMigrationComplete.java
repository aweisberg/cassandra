...
public class OnClusterAssertMigrationComplete extends Action
{
    ...
    {
        System.out.println("Asserting consenus migration is complete");
        ...
        for (IInvokableInstance instance : actions.cluster)
        {
            ...
            {
                System.out.println("Skipping assertion migration is complete on shutdown instance");
                continue;
            }
        ...
        System.out.println("Successfully asserted migration complete");
