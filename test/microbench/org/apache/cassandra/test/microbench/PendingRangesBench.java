...
public class PendingRangesBench
{
    ...
    Multimap<Range<Token>, InetAddressAndPorts> oldPendingRanges;
    ...
    public void setUp() throws UnknownHostException
    {
        ...
        InetAddressAndPorts[] addresses = {InetAddressAndPorts.getByName("127.0.0.1"), InetAddressAndPorts.getByName("127.0.0.2")};
    ...
    public void searchTokenForOldPendingRanges(final Blackhole bh)
    {
        ...
        for (Map.Entry<Range<Token>, Collection<InetAddressAndPorts>> entry : oldPendingRanges.asMap().entrySet())
        {
