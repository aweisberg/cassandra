...
public class PendingRangesBench
{
    ...
    Multimap<Range<Token>, Endpoint> oldPendingRanges;
    ...
    public void setUp() throws UnknownHostException
    {
        ...
        Endpoint[] addresses = { Endpoint.getByName("127.0.0.1"), Endpoint.getByName("127.0.0.2")};
    ...
    public void searchTokenForOldPendingRanges(final Blackhole bh)
    {
        ...
        for (Map.Entry<Range<Token>, Collection<Endpoint>> entry : oldPendingRanges.asMap().entrySet())
        {
