...
public class Instance extends IsolatedExecutor implements IInvokableInstance
{
    ...
    public static SimpleQueryResult unsafeExecuteInternalWithResult(String query, Object ... args)
    {
        ...
        try
        {
            ...
            if (!query.equals("INSERT INTO simple_paxos_simulation.tbl (pk, count, seq) VALUES (?, 0, '') USING TIMESTAMP 0")
                    && !query.equals("INSERT INTO simple_paxos_simulation.tbl (pk, count, seq1, seq2) VALUES (?, 0, '', []) USING TIMESTAMP 0"))
