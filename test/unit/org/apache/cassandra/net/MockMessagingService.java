 ...
 * Alternatively {@link Matcher}s can be created by using helper methods such as {@link #to(InetAddressAndPorts)},
...
public class MockMessagingService
{
     ...
     * provided address.
     */
    public static Matcher<InetAddressAndPorts> to(String address)
    {
        try
        {
            return to(InetAddressAndPorts.getByName(address));
        }
     ...
     * provided address.
     */
    public static Matcher<InetAddressAndPorts> to(InetAddressAndPorts address)
    {
    ...
    {
        return (MessageOut<T> out, InetAddressAndPorts to) -> {
