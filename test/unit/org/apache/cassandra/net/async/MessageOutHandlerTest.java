...
public class MessageOutHandlerTest
{
    ...
    {
        OutboundConnectionIdentifier connectionId = OutboundConnectionIdentifier.small(Endpoint.getByNameOverrideDefaults("127.0.0.1", 0),
                                                                                       Endpoint.getByNameOverrideDefaults("127.0.0.2", 0));
