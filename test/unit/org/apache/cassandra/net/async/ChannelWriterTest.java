...
public class ChannelWriterTest
{
    ...
    public void setup()
    {
        OutboundConnectionIdentifier id = OutboundConnectionIdentifier.small(Endpoint.getByAddressOverrideDefaults(InetAddresses.forString("127.0.0.1"), 0),
                                                                             Endpoint.getByAddressOverrideDefaults(InetAddresses.forString("127.0.0.2"), 0));
