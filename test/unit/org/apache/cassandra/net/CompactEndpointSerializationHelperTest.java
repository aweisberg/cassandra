...
public class CompactEndpointSerializationHelperTest
{
    ...
    private void testAddress(InetAddressAndPorts address, int version) throws Exception
    {
        ByteBuffer out;
        ...
        InetAddressAndPorts roundtripped;
        ...
        else
        {
            ...
            assertEquals(7001, roundtripped.sslport);
        }
    }
}
