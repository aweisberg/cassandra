...
public class MatcherResponse
{
     ...
     */
    public <T, S> MockMessagingSpy respond(BiFunction<MessageOut<T>, InetAddressAndPorts, MessageIn<S>> fnResponse)
    {
    ...
    {
        return respondN((MessageOut<T> msg, InetAddressAndPorts to) -> {
     ...
     * @param fnResponse    function to call for creating reply based on intercepted message and target address
     */
    public <T, S> MockMessagingSpy respondN(BiFunction<MessageOut<T>, InetAddressAndPorts, MessageIn<S>> fnResponse, int limit)
    {
