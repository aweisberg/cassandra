...
public class RateBasedBackPressureTest
{
    ...
    public void testBackPressureStateUpdates()
    {
        ...
        RateBasedBackPressureState state = strategy.newState(Endpoint.getLoopbackAddress());
        state.onMessageSent(null);
        assertEquals(0, state.incomingRate.size());
        assertEquals(0, state.outgoingRate.size());

        state = strategy.newState(Endpoint.getLoopbackAddress());
    ...
    public void testBackPressureFastFlow() throws Exception
    {
        ...
        RateBasedBackPressureState state1 = strategy.newState(Endpoint.getByName("127.0.0.1"));
        RateBasedBackPressureState state2 = strategy.newState(Endpoint.getByName("127.0.0.2"));
        RateBasedBackPressureState state3 = strategy.newState(Endpoint.getByName("127.0.0.3"));
    ...
    public void testBackPressureWithDifferentGroups() throws Exception
    {
        ...
        RateBasedBackPressureState state2 = strategy.newState(Endpoint.getByName("127.0.0.2"));
        RateBasedBackPressureState state3 = strategy.newState(Endpoint.getByName("127.0.0.3"));
        RateBasedBackPressureState state4 = strategy.newState(Endpoint.getByName("127.0.0.4"));
