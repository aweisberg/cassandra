...
public class EC2SnitchTest
{
    ...
    public void testRac() throws IOException, ConfigurationException
    {
        ...
        InetAddressAndPorts local = InetAddressAndPorts.getByName("127.0.0.1");
        InetAddressAndPorts nonlocal = InetAddressAndPorts.getByName("127.0.0.7");
    ...
    {
        InetAddressAndPorts me = InetAddressAndPorts.getByName("127.0.0.2");
        InetAddressAndPorts com_ip = InetAddressAndPorts.getByName("127.0.0.3");
