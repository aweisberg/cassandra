...
public class TokenMetadataTest
{
    ...
    public static void beforeClass() throws Throwable
    {
        ...
        tmd.updateNormalToken(token(ONE), InetAddressAndPorts.getByName("127.0.0.1"));
        tmd.updateNormalToken(token(SIX), InetAddressAndPorts.getByName("127.0.0.6"));
    }
    ...
    {
        final InetAddressAndPorts first = InetAddressAndPorts.getByName("127.0.0.1");
        final InetAddressAndPorts second = InetAddressAndPorts.getByName("127.0.0.6");
