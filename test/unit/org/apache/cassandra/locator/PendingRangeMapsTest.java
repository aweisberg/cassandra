...
public class PendingRangeMapsTest {
    ...
    public void testPendingEndpoints() throws UnknownHostException
    {
        ...
        pendingRangeMaps.addPendingRange(genRange("5", "15"), InetAddressAndPorts.getByName("127.0.0.1"));
        pendingRangeMaps.addPendingRange(genRange("15", "25"), InetAddressAndPorts.getByName("127.0.0.2"));
        pendingRangeMaps.addPendingRange(genRange("25", "35"), InetAddressAndPorts.getByName("127.0.0.3"));
        pendingRangeMaps.addPendingRange(genRange("35", "45"), InetAddressAndPorts.getByName("127.0.0.4"));
        pendingRangeMaps.addPendingRange(genRange("45", "55"), InetAddressAndPorts.getByName("127.0.0.5"));
        pendingRangeMaps.addPendingRange(genRange("45", "65"), InetAddressAndPorts.getByName("127.0.0.6"));
        ...
        Collection<InetAddressAndPorts> endpoints = pendingRangeMaps.pendingEndpointsFor(new BigIntegerToken("15"));
        assertTrue(endpoints.contains(InetAddressAndPorts.getByName("127.0.0.1")));
    }
    ...
    public void testWrapAroundRanges() throws UnknownHostException
    {
        ...
        pendingRangeMaps.addPendingRange(genRange("45", "55"), InetAddressAndPorts.getByName("127.0.0.5"));
        pendingRangeMaps.addPendingRange(genRange("45", "65"), InetAddressAndPorts.getByName("127.0.0.6"));
        pendingRangeMaps.addPendingRange(genRange("65", "7"), InetAddressAndPorts.getByName("127.0.0.7"));
        ...
        Collection<InetAddressAndPorts> endpoints = pendingRangeMaps.pendingEndpointsFor(new BigIntegerToken("6"));
        assertTrue(endpoints.contains(InetAddressAndPorts.getByName("127.0.0.1")));
        assertTrue(endpoints.contains(InetAddressAndPorts.getByName("127.0.0.7")));
    }
}
