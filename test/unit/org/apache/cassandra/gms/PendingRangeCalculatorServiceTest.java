...
public class PendingRangeCalculatorServiceTest
{
    ...
    {
        InetAddressAndPorts otherNodeAddr = InetAddressAndPorts.getByName("127.0.0.2");
    ...
    private Map<InetAddressAndPorts, EndpointState> getStates(InetAddressAndPorts otherNodeAddr, UUID hostId, int ver, boolean bootstrapping)
    {
