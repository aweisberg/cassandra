...
public class SerializationsTest extends AbstractSerializationsTester
{
    ...
    {
        Map<InetAddressAndPorts, EndpointState> states = new HashMap<>();
        states.put(InetAddressAndPorts.getByName("127.0.0.1"), Statics.EndpointSt);
        states.put(InetAddressAndPorts.getByName("127.0.0.2"), Statics.EndpointSt);
    ...
    private static class Statics
    {
...

        {
            ...
            EndpointSt.addApplicationState(ApplicationState.STATUS_WITH_PORTS, vv1);
            for (int i = 0; i < 100; i++)
                Digests.add(new GossipDigest(FBUtilities.getBroadcastAddressAndPorts(), 100 + i, 1000 + 2 * i));
        }
    }
}
