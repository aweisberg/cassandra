...
public class MetadataSerializerTest
{
    ...
    public Map<MetadataType, MetadataComponent> constructMetadata(boolean withNulls)
    {
        ...
        boundariesBuilder.add(new MutationId(1, 12345));
        boundariesBuilder.add(new MutationId(2, 56789));
        return collector.finalizeMetadata(partitioner, bfFpChance, 0, null, false, boundariesBuilder.build(), SerializationHeader.make(cfm, Collections.emptyList()), first, last);
    }
