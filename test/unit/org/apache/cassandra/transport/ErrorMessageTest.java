...
{
    private static Map<InetAddressAndPorts, RequestFailureReason> failureReasonMap1;
    private static Map<InetAddressAndPorts, RequestFailureReason> failureReasonMap2;

    @BeforeClass
    public static void setUpFixtures() throws UnknownHostException
    {
        failureReasonMap1 = new HashMap<>();
        failureReasonMap1.put(InetAddressAndPorts.getByName("127.0.0.1"), RequestFailureReason.READ_TOO_MANY_TOMBSTONES);
        failureReasonMap1.put(InetAddressAndPorts.getByName("127.0.0.2"), RequestFailureReason.READ_TOO_MANY_TOMBSTONES);
        failureReasonMap1.put(InetAddressAndPorts.getByName("127.0.0.3"), RequestFailureReason.UNKNOWN);

        failureReasonMap2 = new HashMap<>();
        failureReasonMap2.put(InetAddressAndPorts.getByName("127.0.0.1"), RequestFailureReason.UNKNOWN);
        failureReasonMap2.put(InetAddressAndPorts.getByName("127.0.0.2"), RequestFailureReason.UNKNOWN);
    }
    ...
    {
        Map<InetAddressAndPorts, RequestFailureReason> modifiableFailureReasons = new HashMap<>(failureReasonMap1);
        ...
        modifiableFailureReasons.put(InetAddressAndPorts.getByName("127.0.0.4"), RequestFailureReason.UNKNOWN);
