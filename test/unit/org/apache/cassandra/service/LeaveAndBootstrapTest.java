...
public class LeaveAndBootstrapTest
{
    ...
    public void newTestWriteEndpointsDuringLeave() throws Exception
    {
        ...
        Map<Token, List<Endpoint>> expectedEndpoints = new HashMap<Token, List<Endpoint>>();
    ...
    public void testSimultaneousMove() throws UnknownHostException
    {
        ...
        Map<String, Multimap<Token, Endpoint>> expectedEndpoints = new HashMap<String, Multimap<Token, Endpoint>>();
        expectedEndpoints.put(KEYSPACE1, HashMultimap.<Token, Endpoint>create());
        ...
        expectedEndpoints.put(KEYSPACE4, HashMultimap.<Token, Endpoint>create());
    ...
    public void testRemovingStatusForNonMember()  throws UnknownHostException
    {
        ...
        StorageService ss = StorageService.instance;
        VersionedValue.VersionedValueFactory valueFactory = new VersionedValue.VersionedValueFactory(partitioner);
        Util.createInitialRing(ss, partitioner, new ArrayList<Token>(), new ArrayList<Token>(), new ArrayList<Endpoint>(), new ArrayList<UUID>(), 1);
        ...
        ss.onChange(Endpoint.getByName("192.168.1.42"), ApplicationState.STATUS_WITH_PORT, valueFactory.removingNonlocal(UUID.randomUUID()));
        ss.onChange(Endpoint.getByName("192.168.1.42"), ApplicationState.STATUS, valueFactory.removingNonlocal(UUID.randomUUID()));
    }
    ...
    private List<Endpoint> getEndpointsFromHosts(List<Endpoint> hosts, String... addresses) throws UnknownHostException
    {
