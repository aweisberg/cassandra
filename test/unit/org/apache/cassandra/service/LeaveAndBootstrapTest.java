...
public class LeaveAndBootstrapTest
{
    ...
    public void newTestWriteEndpointsDuringLeave() throws Exception
    {
        ...
        Map<Token, List<InetAddressAndPorts>> expectedEndpoints = new HashMap<Token, List<InetAddressAndPorts>>();
    ...
    public void testSimultaneousMove() throws UnknownHostException
    {
        ...
        Collection<InetAddressAndPorts> endpoints = null;
        ...
        Map<String, Multimap<Token, InetAddressAndPorts>> expectedEndpoints = new HashMap<String, Multimap<Token, InetAddressAndPorts>>();
        expectedEndpoints.put(KEYSPACE1, HashMultimap.<Token, InetAddressAndPorts>create());
        ...
        expectedEndpoints.put(KEYSPACE4, HashMultimap.<Token, InetAddressAndPorts>create());
    ...
    public void testStateChangeOnRemovedNode() throws UnknownHostException
    {
        ...
        InetAddressAndPorts toRemove = hosts.get(1);
    ...
    public void testRemovingStatusForNonMember()  throws UnknownHostException
    {
        ...
        StorageService ss = StorageService.instance;
        VersionedValue.VersionedValueFactory valueFactory = new VersionedValue.VersionedValueFactory(partitioner);
        Util.createInitialRing(ss, partitioner, new ArrayList<Token>(), new ArrayList<Token>(), new ArrayList<InetAddressAndPorts>(), new ArrayList<UUID>(), 1);
        ...
        ss.onChange(InetAddressAndPorts.getByName("192.168.1.42"), ApplicationState.STATUS_WITH_PORTS, valueFactory.removingNonlocal(UUID.randomUUID()));
        ss.onChange(InetAddressAndPorts.getByName("192.168.1.42"), ApplicationState.STATUS, valueFactory.removingNonlocal(UUID.randomUUID()));
    }
