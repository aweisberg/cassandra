...
public class RangeCommandIteratorTest
{
    ...
    public void testRangeQueried()
    {
        ...
        RangeCommandIterator data = new RangeCommandIterator(replicaPlans, command, ReadCoordinator.DEFAULT, 1, 1000, vnodeCount, nanoTime());
        ...
        data = new RangeCommandIterator(replicaPlans, command, ReadCoordinator.DEFAULT, vnodeCount, 1000, vnodeCount, nanoTime());
        ...
        replicaPlans = replicaPlanIterator(keyRange, keyspace, false);
        data = new RangeCommandIterator(replicaPlans, command, ReadCoordinator.DEFAULT, 1, 1, vnodeCount, nanoTime());
        ...
        data = new RangeCommandIterator(replicaPlans, command, ReadCoordinator.DEFAULT, 1, 1000, vnodeCount, nanoTime());
        verifyRangeCommandIterator(data, rows, 1, vnodeCount);
