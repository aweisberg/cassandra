...
public class MutationTrackingMigrationRepairResultTest
{
    ...
    public void testGlobalIncrementalDataRepairEligible()
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, false, false, true, true, true, false);
    ...
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, true, false, true, true, true, false);
    ...
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, false, true, true, true, true, false);
        assertFalse(result.eligible);
        assertEquals(Epoch.EMPTY, result.minEpoch);
    ...
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, false, false, false, true, true, false);
        assertFalse(result.eligible);
        assertEquals(Epoch.EMPTY, result.minEpoch);
    ...
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, false, false, true, false, true, false);
        assertFalse(result.eligible);
        assertEquals(Epoch.EMPTY, result.minEpoch);
    ...
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, false, false, true, true, false, false);
        assertFalse(result.eligible);
        assertEquals(Epoch.EMPTY, result.minEpoch);
    ...
    @Test
    public void testPullRepairIneligible()
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, false, false, true, true, true, true);
        assertFalse(result.eligible);
        assertEquals(Epoch.EMPTY, result.minEpoch);
        assertTrue(result.ineligibleReason.contains("only streamed data one way"));
    }
}
