...
public class StorageServiceServerTest
{
    ...
    public void testPrimaryRangeForEndpointWithinDCWithNetworkTopologyStrategy() throws Exception
    {
        ...
        Collection<Range<Token>> primaryRanges = StorageService.instance.getPrimaryRangeForEndpointWithinDC(meta.name,
                                                                                                            InetAddressAndPorts.getByName("127.0.0.1"));
        ...
        primaryRanges = StorageService.instance.getPrimaryRangeForEndpointWithinDC(meta.name, InetAddressAndPorts.getByName("127.0.0.2"));
        assertEquals(2, primaryRanges.size());
        ...
        primaryRanges = StorageService.instance.getPrimaryRangeForEndpointWithinDC(meta.name, InetAddressAndPorts.getByName("127.0.0.4"));
        assertEquals(2, primaryRanges.size());
        assertTrue(primaryRanges.contains(new Range<Token>(new StringToken("D"), new StringToken("A"))));
        assertTrue(primaryRanges.contains(new Range<Token>(new StringToken("A"), new StringToken("B"))));

        primaryRanges = StorageService.instance.getPrimaryRangeForEndpointWithinDC(meta.name, InetAddressAndPorts.getByName("127.0.0.5"));
        assertEquals(2, primaryRanges.size());
        assertTrue(primaryRanges.contains(new Range<Token>(new StringToken("B"), new StringToken("C"))));
        assertTrue(primaryRanges.contains(new Range<Token>(new StringToken("C"), new StringToken("D"))));
    }
    ...
    public void testPrimaryRangesWithNetworkTopologyStrategy() throws Exception
    {
        ...
        Collection<Range<Token>> primaryRanges = StorageService.instance.getPrimaryRangesForEndpoint(meta.name, InetAddressAndPorts.getByName("127.0.0.1"));
        assert primaryRanges.size() == 1;
        assert primaryRanges.contains(new Range<Token>(new StringToken("D"), new StringToken("A")));

        primaryRanges = StorageService.instance.getPrimaryRangesForEndpoint(meta.name, InetAddressAndPorts.getByName("127.0.0.2"));
        assert primaryRanges.size() == 1;
        assert primaryRanges.contains(new Range<Token>(new StringToken("B"), new StringToken("C")));

        primaryRanges = StorageService.instance.getPrimaryRangesForEndpoint(meta.name, InetAddressAndPorts.getByName("127.0.0.4"));
        assert primaryRanges.size() == 1;
        assert primaryRanges.contains(new Range<Token>(new StringToken("A"), new StringToken("B")));

        primaryRanges = StorageService.instance.getPrimaryRangesForEndpoint(meta.name, InetAddressAndPorts.getByName("127.0.0.5"));
        assert primaryRanges.size() == 1;
    ...
    public void testPrimaryRangeForEndpointWithinDCWithNetworkTopologyStrategyOneDCOnly() throws Exception
    {
        ...
        // endpoints in DC1 should not have primary range
        Collection<Range<Token>> primaryRanges = StorageService.instance.getPrimaryRangeForEndpointWithinDC(meta.name, InetAddressAndPorts.getByName("127.0.0.1"));
        assertTrue(primaryRanges.isEmpty());

        primaryRanges = StorageService.instance.getPrimaryRangeForEndpointWithinDC(meta.name,
                                                                                   InetAddressAndPorts.getByName("127.0.0.2"));
        assertTrue(primaryRanges.isEmpty());
    ...
    public void testPrimaryRangesWithVnodes() throws Exception
    {
        ...
        metadata.clearUnsafe();
        // DC1
        Multimap<InetAddressAndPorts, Token> dc1 = HashMultimap.create();
        dc1.put(InetAddressAndPorts.getByName("127.0.0.1"), new StringToken("A"));
        dc1.put(InetAddressAndPorts.getByName("127.0.0.1"), new StringToken("E"));
        dc1.put(InetAddressAndPorts.getByName("127.0.0.1"), new StringToken("H"));
        dc1.put(InetAddressAndPorts.getByName("127.0.0.2"), new StringToken("C"));
        dc1.put(InetAddressAndPorts.getByName("127.0.0.2"), new StringToken("I"));
        dc1.put(InetAddressAndPorts.getByName("127.0.0.2"), new StringToken("J"));
        metadata.updateNormalTokens(dc1);
        // DC2
        Multimap<InetAddressAndPorts, Token> dc2 = HashMultimap.create();
        dc2.put(InetAddressAndPorts.getByName("127.0.0.4"), new StringToken("B"));
        dc2.put(InetAddressAndPorts.getByName("127.0.0.4"), new StringToken("G"));
        dc2.put(InetAddressAndPorts.getByName("127.0.0.4"), new StringToken("L"));
        dc2.put(InetAddressAndPorts.getByName("127.0.0.5"), new StringToken("D"));
        dc2.put(InetAddressAndPorts.getByName("127.0.0.5"), new StringToken("F"));
        dc2.put(InetAddressAndPorts.getByName("127.0.0.5"), new StringToken("K"));
    ...
    public void testPrimaryRangesWithSimpleStrategy() throws Exception
    {
        ...
        metadata.updateNormalToken(new StringToken("A"), InetAddressAndPorts.getByName("127.0.0.1"));
        metadata.updateNormalToken(new StringToken("B"), InetAddressAndPorts.getByName("127.0.0.2"));
        metadata.updateNormalToken(new StringToken("C"), InetAddressAndPorts.getByName("127.0.0.3"));
        ...
        primaryRanges = StorageService.instance.getPrimaryRangesForEndpoint(meta.name, InetAddressAndPorts.getByName("127.0.0.3"));
        assert primaryRanges.size() == 1;
        assert primaryRanges.contains(new Range<Token>(new StringToken("B"), new StringToken("C")));
    }
    ...
    public void testPrimaryRangeForEndpointWithinDCWithSimpleStrategy() throws Exception
    {
        ...
        primaryRanges = StorageService.instance.getPrimaryRangeForEndpointWithinDC(meta.name, InetAddressAndPorts.getByName("127.0.0.3"));
        assert primaryRanges.size() == 1;
        assert primaryRanges.contains(new Range<Token>(new StringToken("B"), new StringToken("C")));
    }
    ...
    public void testCreateRepairRangeFrom() throws Exception
    {
        ...
        metadata.updateNormalToken(new LongToken(1000L), InetAddressAndPorts.getByName("127.0.0.1"));
        metadata.updateNormalToken(new LongToken(2000L), InetAddressAndPorts.getByName("127.0.0.2"));
        metadata.updateNormalToken(new LongToken(3000L), InetAddressAndPorts.getByName("127.0.0.3"));
        metadata.updateNormalToken(new LongToken(4000L), InetAddressAndPorts.getByName("127.0.0.4"));
