...
public class LegacySystemKeyspaceMigratorTest extends CQLTester
{
    ...
    public void testMigratePeers() throws Throwable
    {
        ...
        for (UntypedResultSet.Row row : execute(String.format("SELECT * FROM %s", LegacySystemKeyspaceMigrator.peersName)))
        {
            ...
            assertEquals(DatabaseDescriptor.getSSLStoragePort(), row.getInt("peer_sslport"));
            ...
            assertEquals(DatabaseDescriptor.getSSLStoragePort(), row.getInt("preferred_sslport"));
            ...
            assertEquals(DatabaseDescriptor.getNativeTransportPortSSL(), row.getInt("native_sslport"));
